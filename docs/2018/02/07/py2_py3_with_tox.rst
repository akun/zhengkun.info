...
不少 Python 项目会遇到从 Python 2 到 Python 3 过渡的问题，由于过渡需要持续一段\
时间，所以代码得保证在 Python 2 和 Python 3 中都能运行正常。为了解决这个问题，\
所以需要引入 tox 这个工具。
...
.. literalinclude:: onepiece/onepiece/main.py

test_main.py
~~~~~~~~~~~~

.. literalinclude:: onepiece/tests/test_main.py

setup.py
~~~~~~~~

.. literalinclude:: onepiece/setup.py

tox.ini
~~~~~~~

.. literalinclude:: onepiece/tox.ini
