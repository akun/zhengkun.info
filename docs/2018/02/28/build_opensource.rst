...
* 尽可能多的记录软件开发中产生的常见行为，参考：
  《 `如何理解版本控制系统 <http://zhengkun.info/2014/07/06/how-to-understanding-vcs/>`_ 》。
...
.. literalinclude:: onepiece/onepiece/example.py

同样，测试代码也很简单，代码如下：

.. literalinclude:: onepiece/tests/test_example.py
...
《 `Python 中的单元测试 <http://zhengkun.info/2013/06/04/unittest-in-python/>`_ 》
...
很多人习惯用这个写文档。用 Sphinx 写技术文档，详见：
《 `用 Sphinx 编写技术文档 <http://zhengkun.info/2014/02/10/sphinx-doc/>`_ 》。
...
可以先简单看下这里：
《 `做开源软件项目会用到的服务简介 <http://zhengkun.info/2014/03/28/do-opensource-project-will-use-some-service/>`_ 》，对配套服务有简单介绍。
...
.. author:: default
.. categories:: project project, build
